...
happyExpList = Happy_Data_Array.listArray (0,168) ([16496,8224,0,0,0,65020,0,0,0,7168,2064,8248,32784,24511,4864,49152,33025,896,258,1031,3586,1032,4124,14344,4128,16496,57376,16512,448,32897,515,1793,516,2062,7172,2064,3264,32768,4121,13056,48,28774,52224,240,61848,1,0,608,0,0,0,0,0,8192,0,72,1792,516,63472,7187,2064,0,0,0
	])
...
action_8 (23) = happyShift action_36
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenEq -> cont 16;
	TokenDiff -> cont 17;
	TokenMenoIngual -> cont 18;
	TokenMeno -> cont 19;
	TokenMaioIngual -> cont 20;
	TokenMaio -> cont 21;
	TokenIf -> cont 22;
	TokenThen -> cont 23;
	TokenElse -> cont 24;
